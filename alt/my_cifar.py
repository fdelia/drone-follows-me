...
# Network Parameters
n_input = 40 * 40 * 3  # Cifar ckpt input (img shape: 32*32)
...
NUM_CLASSES = 2  # Cifar10 total classes (0-9 digits)
...
def inference(images):
  ...
  images = tf.reshape(images, shape=[-1, 40, 40, 3])
  ...
  # 5x5 conv, 64 inputs, 64 outputs
    'wd1': tf.Variable(tf.random_normal([out_conv_2 * 10 * 10, n_hidden_1], stddev=1e-3)),
